...
class FinalPackingModel extends MasterModel{
    ...
    public function getDTRows($data){
        ...
        $data['select'] = "final_packing_trans.*,final_packing_master.trans_number,final_packing_master.trans_date,final_packing_master.status,item_master.item_name,so_master.trans_number AS so_number,party_master.party_name";
    ...
    public function getPackingData($data = []){
        ...
        $queryData['select'] = "final_packing_master.*,employee_master.emp_name As prepared_by,transport_master.transport_name,party_master.party_name,party_master.party_address,party_master.party_mobile";
    ...
    public function getPackingItemDetail($data = [] ){
        ...
        $queryData['select'] = "final_packing_trans.*,item_master.item_name,item_master.item_code,item_master.wt_pcs,so_master.trans_number AS so_number,so_master.doc_no,so_master.doc_date,material_master.material_grade,so_master.id AS so_id";
    ...
    public function getFinalPackingBoxDetail($data = []){
        ...
        if(!empty($data['primaryPackBatch'])){
            $queryData['select'] .= ',primary_packing_batch.qty AS batch_qty, primary_packing_batch.batch_no AS prd_batch,primary_packing_batch.batch_no AS primary_batch';
