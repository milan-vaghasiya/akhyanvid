...
class PackingModel extends MasterModel{
    ...
    public function getDTRows($data){
        ...
        $data['leftJoin']['(SELECT SUM(qty) AS stock_qty,batch_no,item_id FROM stock_trans WHERE is_delete = 0 AND location_id = '.$this->RTD_STORE->id.' GROUP BY item_id,batch_no ) AS stockTrans'] = 'stockTrans.item_id = packing_master.item_id AND stockTrans.batch_no = packing_master.trans_number';
