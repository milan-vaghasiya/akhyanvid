...
class StockVerificationModel extends MasterModel
{
    ...
    public function getDTRows($data) {
        ...
        $data['select'] = "stock_trans.*,SUM(stock_trans.qty * stock_trans.p_or_m) as stock_qty,item_master.item_name,item_master.item_code,item_master.item_type,item_master.uom"; 
