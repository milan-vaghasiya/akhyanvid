        ...
        <div class="row">
            <div class="col-sm-12">
				<div class="page-title-box">
					...
					<div class="float-end">
                        <?php
                            $addParam = "{'modal_id' : 'bs-right-md-modal', 'call_function':'addCustomerComplaints', 'form_id' : 'addCustomerComplaints', 'title' : 'Add Customer Complaints'}";
                        ?>
                        <button type="button" class="btn waves-effect waves-light btn-outline-dark permission-write float-right press-add-btn" onclick="modalAction(<?=$addParam?>);"><i class="fa fa-plus"></i> Add Complaints</button>
					</div>
				</div>
            </div>
		</div>
					...
					<div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id='customerComplaintsTable' class="table table-bordered ssTable ssTable-cf" data-url='/getDTRows'></table>
                            </div>
                        </div>
					</div>
				</div>
