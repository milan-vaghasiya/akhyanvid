            ...
            <div class="col-12">
                ...
                <table class="table bg-light-grey">
                    <tr class="" style="letter-spacing: 2px;font-weight:bold;padding:2px !important; border-bottom:1px solid #000000;">
                        <td style="width:33%;" class="fs-12 text-left">GSTIN: <?=$companyData->company_gst_no?></td>
                        <td style="width:34%;" class="fs-18 text-center">Delivery Challan</td>
                        <td style="width:33%;" class="fs-12 text-right"></td>
                    </tr>
                </table>
                
                <table class="table item-list-bb fs-22" style="margin-top:5px;">
                    <tr>
                        <td rowspan="3" style="width:67%;vertical-align:top;">
                    ...
                    <tr>
				        <th class="text-left">D.C. Date</th>
                        <td><?=formatDate($dataRow->trans_date)?></td>
                    </tr>
                    <tr>
                        <th class="text-left">Transport Mode</th>
                        <td><?=(!empty($dataRow->packingList->method_of_dispatch) ? $dataRow->packingList->method_of_dispatch:"")?></td>
                    </tr>
                </table>
                ...
                <table class="table item-list-bb" style="margin-top:10px;">
                    <thead>
                        <tr>
                            ...
                            <th style="width:90px;">Sales Order</th>
                            <th style="width:90px;">Customer Po. No.</th>
                    ...
                    <tbody>
                            ...
                            if(!empty($dataRow->itemList)):
                                foreach($dataRow->itemList as $row):
                                    ...
                                    echo '<tr>';
                                        ...
                                        echo '<td class="text-center">'.$row->so_no.'</td>';
                                        echo '<td class="text-center">'.$row->cust_po_no.'</td>';
                        ...
                        <tr>
                            <th colspan="3" class="text-left">Total Box. : <?=(!empty($dataRow->packingList->boxNo) ? $dataRow->packingList->boxNo : 0)?></th>
                            <th colspan="3" class="text-left">Total Weight. : <?=(!empty($dataRow->packingList->boxWt) ?$dataRow->packingList->boxWt :0)?> KGS</th>
                        </tr>                                
                    </tbody>  
                </table>
