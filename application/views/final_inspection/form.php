        ...
        <div class="row">
            <div class="card">
                <div class="media align-items-center btn-group process-tags">
                    <span class="badge bg-light-peach btn flex-fill"><?=$dataRow->item_name?></span>
                    ...
                    <select name="rev_no" id="rev_no" class="form-control select2">
                        ...
                        <?php
                            foreach ($revList as $row) :
                                $selected = ((!empty($dataRow->rev_no) && $dataRow->rev_no == $row->rev_no)?"selected" :"" );
                                echo '<option value="' . $row->rev_no . '" ' . $selected . '>' . $row->rev_no . '</option>';
                            endforeach;
                        ?>
                    </select>
                </div> 
                            ...
                            if(!empty($paramData)):
                                foreach($paramData as $row):
                                    ...
                                    $tbodyData .= '<tr class="text-center">
                                            ...
                                            <td style="width:20px;">'.$row->min_value.'</td>
                                            <td style="width:20px;">'.$row->max_value.'</td>';
