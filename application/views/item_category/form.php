    ...
    <div class="col-md-12">
        <div class="row">
			...
			<div class="col-md-12 form-group">
                ...
                <select name="ref_id" id="ref_id" class="form-control basic-select2 req">
            ...
            <div class="col-md-6 form-group">
                ...
                <select name="final_category" id="final_category" class="form-control basic-select2">
            ...
            <div class="col-md-6 form-group ">
                ...
                <select name="is_return" id="is_return" class="form-control basic-select2">
