            ...
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-12 float-end">         
                        ...
                        ?>       
                        <a class="btn btn-success float-end" href="javascript:void(0)" datatip="Approve" flow="down" onclick="confirmPurchaseStore(<?=$param?>)"><i class="fas fa-check"></i> Save</a>
                    </div>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table jpExcelTable">
                            ...
                            <tr>
                                ...
                                <td style="width:25%"><?= (!empty($quoteData->qty)) ? floatval($quoteData->qty) : '' ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td><b>Remark</b></td>
                                <td colspan="3"><?= (!empty($quoteData->item_remark)) ? $quoteData->item_remark : '' ?></td>
                            </tr>
                        </table>
                    </div>
