        ...
        <div class="row">
            <div class="col-12">
                ...
                <table class="table item-list-bb fs-22" style="margin-top:5px;">
					...
					<tr>
                        <td colspan="3">Delivery Address : <?=(!empty($dataRow->delivery_address) ? $dataRow->delivery_address ." - ".$dataRow->delivery_pincode :"")?></td>
                    </tr>
                </table>
                ...
                <table class="table item-list-bb" style="margin-top:10px;">
					<thead>
						<tr>
							...
							<th style="width:80px;">Commercial Qty</th>
							...
							if(!empty($dataRow->itemList)):
								foreach($dataRow->itemList as $row):
									...
									echo '<tr>';
										...
										echo '<td class="text-right">'.sprintf('%0.2f',$row->com_qty).' <small>'.$row->unit_name.'</small></td>';
										echo '<td class="text-center">'.$row->price.'</td>';
										echo '<td class="text-center">'.$row->disc_per.'</td>';
										echo '<td class="text-center">'.$row->gst_per.'</td>';
										echo '<td rowspan='.$rowspan.' class="text-right">'.$row->taxable_amount.'</td>';
									echo '</tr>';
									echo (!empty($row->item_remark)) ? '<tr><td colspan="6">Notes : '.$row->item_remark.'</td></tr>' : '';
									$totalQty += $row->qty;
								endforeach;
							endif;
						?>
