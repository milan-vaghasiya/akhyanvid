...
<div class="row">
	<div class="col-12">
		<table class="table" style="margin-top:10px;"><tr><td class="fs-18 text-center" style="letter-spacing: 2px;font-weight:bold;padding:0px !important;">PURCHASE ORDER</td></tr></table>
		...
		<table class="table item-list-bb" style="margin-top:10px;">
			...
			<?php
				...
				$gstRow='<tr>
            				...
            				<td class="text-right">'.sprintf('%.2f',$poData->cgst_amount).'</td>
            			</tr>';
				$gstRow.='<tr>
            				<th colspan="2" class="text-right">SGST @'.$msgst.'%</th>
            				<td class="text-right">'.sprintf('%.2f',$poData->sgst_amount).'</td>
            			</tr>';
			...
			<tr>
				<th colspan="5" rowspan="<?=$rwspan?>">Amount In Words : <?=numToWordEnglish($poData->net_amount)?></th>
				<th colspan="2" class="text-right">P & F</th>
				<td class="text-right"><?=sprintf('%.2f',$poData->packing_amount)?></td>
			</tr>
			<!-- <tr>
				<th colspan="2" class="text-right">Freight</th>
				<td class="text-right"><?=sprintf('%.2f',$poData->freight_amount)?></td>
			</tr> -->
			<tr>
