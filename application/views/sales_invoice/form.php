                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="hiddenInput">
											...
											<input type="hidden" name="party_name" id="party_name" value="<?=(!empty($dataRow->party_name))?$dataRow->party_name:((!empty($party_name))?$party_name:"")?>">
                                        ...
                                        <div class="col-md-2 form-group">
                                            ...
                                            <div class="input-group">
												<select name="trans_prefix" id="trans_prefix" class="form-control">
													<option value="DFG/<?=$this->shortYear?>/" <?=(!empty($dataRow->trans_prefix) && $dataRow->trans_prefix == "DFG/".$this->shortYear."/")?"selected":""?> >DFG/<?=$this->shortYear?>/</option>
													<option value="DFI/<?=$this->shortYear?>/" <?=(!empty($dataRow->trans_prefix) && $dataRow->trans_prefix == "DFI/".$this->shortYear."/")?"selected":""?> >DFI/<?=$this->shortYear?>/</option>
													<option value="DEP/<?=$this->shortYear?>/" <?=(!empty($dataRow->trans_prefix) && $dataRow->trans_prefix == "DEP/".$this->shortYear."/")?"selected":""?> >DEP/<?=$this->shortYear?>/</option>
													<option value="GT/<?=$this->shortYear?>/" <?=(!empty($dataRow->trans_prefix) && $dataRow->trans_prefix == "GT/".$this->shortYear."/")?"selected":""?> >GT/<?=$this->shortYear?>/</option>
												</select>
                                            ...
                                            <input type="hidden" name="trans_number" id="trans_number" class="form-control" value="<?=(!empty($dataRow->trans_number))?$dataRow->trans_number:((!empty($trans_number))?$trans_number:"")?>">
                                            ...
                                            <div class="float-right">	
                                                ...
                                                <span class="dropdown float-right m-r-10" >
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY" x-placement="start-left" style="left: -87px;">
                                                        ...
                                                        <!-- <button type="button" class="dropdown-item getPendingDispatchOrder"><i class="fa fa-plus"></i> Dispatch Order</button> -->
                                                    </div>                                                    
                                                </span>
                                            </div>
                                        ...
                                        <div class="col-md-2 form-group">
                                            ...
                                            <input type="text" name="doc_no" id="doc_no" class="form-control" value="<?=(!empty($dataRow->doc_no))?$dataRow->doc_no:((!empty($doc_no))?$doc_no:"")?>">
                                        </div>
                                        ...
                                        <div class="col-md-2 form-group">
                                            ...
                                            <input type="hidden" name="masterDetails[t_col_4]" id="master_t_col_4" value="<?=(!empty($dataRow->transporter_name))?$dataRow->transporter_name:""?>">                                            
                                        </div>

                                        <div class="col-md-2 form-group">
                                            <label for="master_t_col_5">Trasport Id</label>
                                            <input type="text" name="masterDetails[t_col_5]" id="master_t_col_5" class="form-control" value="<?=(!empty($dataRow->transporter_gst_no))?$dataRow->transporter_gst_no:""?>" readonly />
                                        </div>
										<div class="col-md-2 form-group">
                                            <label for="master_t_col_6">Vehicle No.</label>
                                            <input type="text" name="masterDetails[t_col_6]" id="master_t_col_6" class="form-control" value="<?=(!empty($dataRow->vehicle_no))?$dataRow->vehicle_no:""?>" />
                                        </div>
										<div class="col-md-2 form-group">
                                            <label for="master_t_col_7">L.R. No.</label>
                                            <input type="text" name="masterDetails[t_col_7]" id="master_t_col_7" class="form-control" value="<?=(!empty($dataRow->lr_no))?$dataRow->lr_no:""?>" />
                                        </div>
										<div class="col-md-2 form-group">
                                            <label for="master_date_col_1">L.R. Date</label>
                                            <input type="date" name="masterDetails[date_col_1]" id="master_date_col_1" class="form-control" value="<?=(!empty($dataRow->lr_date))?$dataRow->lr_date:""?>" />
                                        </div>
										...
										<div class="col-md-4 form-group">
                                            ...
                                            <input type="text" name="masterDetails[t_col_3]" id="master_t_col_3" class="form-control" value="<?=((!empty($dataRow->ship_address))?$dataRow->ship_address:(!empty($shipTo->ship_address) ? $shipTo->ship_address : ""));?>">
                                        </div>
										
										<div class="col-md-2 form-group">
                                            <label for="master_t_col_8">Ship Pincode</label>
                                            <input type="text" name="masterDetails[t_col_8]" id="master_t_col_8" class="form-control" value="<?=(!empty($dataRow->delivery_pincode))?$dataRow->delivery_pincode:(!empty($shipTo->delivery_pincode) ? $shipTo->delivery_pincode : "");?>">
                                        </div>
...
if(!empty($invItem)):
	foreach($invItem as $row): 
		if(!empty($from_entry_type) && $from_entry_type == 14){$row->qty = $row->qty; $row->ref_id = $row->id;
            $row->request_id = 0;}
		if(!empty($from_entry_type) && $from_entry_type == 190){
            $row->qty = $row->pallet_pck_qty; $row->ref_id = $row->id;
            $row->request_id = $row->request_id;
            $row->batch_detail = json_encode( $row->batch_detail);
		 }
		 $row->stock_eff = 1;
		if(!empty($from_entry_type) && $from_entry_type == 177){
			$row->qty = $row->pending_qty; $row->ref_id = $row->id;
