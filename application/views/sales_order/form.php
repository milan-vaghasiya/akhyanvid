                                ...
                                <div class="col-md-12">
                                    <div class="row">
										...
										<!-- <div class="col-md-4 form-group">
                                            ...
                                            <select name="ship_to" id="ship_to" class="form-control select2" data-party_category="1,2">
                                                <option value="">Select Party</option>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <span class="dropdown float-right">
									<a class="text-primary font-bold waves-effect waves-dark mr-5" href="javascript:void(0);" onclick="soLastRec()" datatip="Info" flow="down">Info</a>
                                    <a class="text-primary font-bold waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" datatip="Progress" flow="down">+ Add New</a>
							...
							<div class="col-md-12 mt-3" id="soLastRec">
                                <div class="row form-group">
                                    <div class="table-responsive">
                                        <table id="soLastRecTable" class="table table-striped table-borderless">
                                            <thead class="thead-dark">
                                                <tr>
                                                    <th class="text-center" style="width:5%;">#</th>
                                                    <th class="text-center" style="width:20%;">SO Date</th>
                                                    <th class="text-center">Customer</th>
                                                    <th class="text-center" style="width:10%;">Qty.</th>
                                                    <th class="text-center" style="width:10%;">Price</th>
                                                </tr>
                                            </thead>
                                            <tbody id="tbodySOLastRec">
