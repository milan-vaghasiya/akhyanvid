				...
				<div class="page-title-box">
                    <div class="float-start">
					    <ul class="nav nav-pills">
                            ...
                            <li class="nav-item"> 
                                <button onclick="statusTab('salesOrderTable',2);" id="close_so" class="nav-tab btn waves-effect waves-light btn-outline-primary" style="outline:0px" data-toggle="tab" aria-expanded="false">Short Close</button> 
                            </li>
                        </ul>
					</div>
					<div class="float-end">
