            ...
            <div class="col-12">
                ...
                <table class="table item-list-bb fs-22" style="margin-top:5px;">
                    <tr >
                        <td rowspan="4" style="width:67%;vertical-align:top;">
                            ...
                            Contact No.& Email : <?=$dataRow->contact_no?> & <?=$partyData->party_email?><br>
                            GSTIN : <?=$dataRow->gstin?><br><br>
							
							<b>Delivery Address : </b><br>
                            <?=(!empty($dataRow->delivery_address) ? $dataRow->delivery_address ." - ".$dataRow->delivery_pincode : '')?><br>
                        </td>
                        <td>
                            <b>SO. No.</b>
                        </td>
                ...
                <table class="table item-list-bb" style="margin-top:10px;">
                    ...
                    <tbody>
                            ...
                            if(!empty($dataRow->itemList)):
                                foreach($dataRow->itemList as $row):
                                    ...
                                    echo '<tr>';
                                        ...
                                        echo '<td>'.$row->item_name.$indent.$item_remark.'</td>';
                        ...
                        ?>
                        <tr>
                            <th colspan="2" class="text-left">Remark : <?=($dataRow->remark)?></th>
