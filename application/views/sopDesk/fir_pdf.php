	...
	<div class="col-12">
		<table class="table item-list-bb" style="margin-top:2px;">
			...
			<tr class="text-left">
				...
				<td colspan="4"><?=(!empty($firData->item_name)) ? $firData->item_name : ""?></td>
			</tr>
		</table>
					...
					foreach($paramData as $row):
						...
						$flag=false;$paramItems = '';
							$paramItems.= '<tr>
										...
										<td style="text-align:left;width:15%">'.$row->parameter.'</td>
										<td style="text-align:left;width:15%">'.$row->specification.'</td>   
										<td style="text-align:left;width:15%">'.$row->instrument.'</td>';
