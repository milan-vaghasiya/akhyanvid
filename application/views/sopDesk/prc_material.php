<?php
	...
	if(!empty($prcMaterialData))
	{
        ...
        foreach($prcMaterialData as $row){
            ...
            $uq = floatval($row->production_qty * $row->ppc_qty);
                                ...
                                <div class="card sh-perfect">
                                    <div class="card-body">                                    
                                        <div class="task-box">
                                            ...
                                            <h6 class="mt-0 fw-semibold">Consumption Per Piece: <span class="text-muted font-weight-normal"> '.floatval($row->ppc_qty).'</span></h6>    
