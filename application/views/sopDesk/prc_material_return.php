<form data-res_function="getReturnResponse">
    ...
    <div class="row">
		...
		<div class="col-md-4 form-group location">
            ...
            <?php $locations = !empty($dataRow->location_id)?explode(",",$dataRow->location_id):[]; ?>
...
$(document).ready(function(){
    if(!tbodyData){
        var postData = {'postData':{'prc_id':$("#prc_id").val(),'item_id':$("#item_id").val(),},'table_id':"returnTable",'tbody_id':'returnTbodyData','tfoot_id':'','fnget':'getReturnHtml'};
