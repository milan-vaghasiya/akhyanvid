                ...
                <div class="page-title-box">
                    <div class="float-start">
                        <ul class="nav nav-pills">
                            ...
                            <li class="nav-item"> 
                                <a href="<?=base_url($headData->controller."/issueRequisition/1/1")?>" class="btn waves-effect waves-light btn-outline-info <?=($status == 1) ? "active" : ""?> mr-1"> Pending </a> 
                            </li>
                            <li class="nav-item"> 
                                <a href="<?=base_url($headData->controller."/issueRequisition/2/2")?>" class="btn waves-effect waves-light btn-outline-info <?=($status == 2) ? "active" : ""?> mr-1"> Issued </a>
                            </li>
                        </ul>
                    </div>
                    <div class="float-end">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id='issueRequisitionTable' class="table table-bordered ssTable" data-url='/getIssueDTRows/<?=$status?>/<?=$issue_type?>'></table>
                        </div>
                    </div>
                </div>
            </div>
