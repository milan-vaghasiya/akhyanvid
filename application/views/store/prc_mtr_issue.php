...
<script>
    ...
    $(document).ready(function(){
        if(!tbodyData){
            var postData = {'postData':{'prc_id':$("#prc_id").val(),'req_number':$("#req_number").val()},'table_id':"itemTable",'tbody_id':'itemTbody','tfoot_id':'','fnget':'getItemsForIssue','controller':'store'};
